...
/* $Id: microcode.c,v 1.6 2003/04/17 14:15:07 hampa Exp $ */
...
unsigned op_00 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags (c, 8, DEFFLG, d, s1, e86_add_uint4 (s1, s2));
...
unsigned op_01 (e8086_t *c)
{
  ...
  e86_set_ea16 (c, d);
  e86_set_flags (c, 16, DEFFLG, d, s1, e86_add_uint4 (s1, s2));
...
unsigned op_08 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags (c, 8, E86_FLG_Z | E86_FLG_S | E86_FLG_P, d, s1, 0);
...
unsigned op_09 (e8086_t *c)
{
  ...
  e86_set_ea16 (c, d);
  e86_set_flags (c, 16, E86_FLG_Z | E86_FLG_S | E86_FLG_P, d, s1, 0);
  e86_set_f0 (c, E86_FLG_C | E86_FLG_O);
...
unsigned op_10 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags (c, 8, DEFFLG, d, s1, e86_add_uint4 (s1, s2) + s3);
  e86_set_clk_ea (c, 3, 16);
...
unsigned op_11 (e8086_t *c)
{
  ...
  e86_set_ea16 (c, d);
  e86_set_flags16 (c, DEFFLG, d, s1);
  e86_set_flags_af (c, e86_add_uint4 (s1, s2) + s3);
  e86_set_clk_ea (c, 3, 16);
...
unsigned op_18 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags8 (c, DEFFLG, d, s1);
  e86_set_flags_af (c, e86_sub_uint4 (s1, s2) - s3);
...
unsigned op_20 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags8 (c, E86_FLG_S | E86_FLG_Z | E86_FLG_P, d, s1);
  e86_set_f (c, E86_FLG_O | E86_FLG_C, 0);
  e86_set_clk_ea (c, 3, 16);
...
unsigned op_21 (e8086_t *c)
{
  ...
  e86_set_ea16 (c, d);
  e86_set_flags16 (c, E86_FLG_S | E86_FLG_Z | E86_FLG_P, d, s1);
  e86_set_f (c, E86_FLG_O | E86_FLG_C, 0);
  e86_set_clk_ea (c, 3, 16);
...
unsigned op_40 (e8086_t *c)
{
  ...
  e86_set_flags16 (c, DEFFLG & ~E86_FLG_C, d, s);
...
unsigned op_80_00 (e8086_t *c)
{
  ...
  e86_set_flags8 (c, DEFFLG, d, s1);
  e86_set_flags_af (c, e86_add_uint4 (s1, s2));
...
unsigned op_80_04 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags8 (c, E86_FLG_S | E86_FLG_Z | E86_FLG_P, d, s1);
  e86_set_f0 (c, E86_FLG_O | E86_FLG_C);
  e86_set_clk_ea (c, 4, 17);
...
unsigned op_8a (e8086_t *c)
{
  ...
  e86_set_reg8 (c, reg, e86_get_ea8 (c));
...
unsigned op_8b (e8086_t *c)
{
  ...
  e86_set_reg16 (c, reg, e86_get_ea16 (c));
...
unsigned op_90 (e8086_t *c)
{
  ...
  val = c->dreg[E86_REG_AX];
  c->dreg[E86_REG_AX] = c->dreg[reg];
  c->dreg[reg] = val;
...
{
  c->flg &= 0xff00;
  c->flg |= (c->dreg[E86_REG_AX] >> 8) & 0xff;
...
unsigned op_a4 (e8086_t *c)
{
  ...
  if (c->prefix & E86_PREFIX_REPN) {
    fprintf (stderr, "movsb with repn\n");
  }
  if (c->prefix & E86_PREFIX_REP) {
    while (c->dreg[E86_REG_CX] > 0) {
      val = e86_get_mem8 (c, seg1, c->dreg[E86_REG_SI]);
      e86_set_mem8 (c, seg2, c->dreg[E86_REG_DI], val);
...
unsigned op_a6 (e8086_t *c)
{
  ...
  if (c->prefix & (E86_PREFIX_REP | E86_PREFIX_REPN)) {
    ...
    while (c->dreg[E86_REG_CX] > 0) {
      ...
      e86_set_flags8 (c, DEFFLG, s1 - s2, s1);
      e86_set_flags_af (c, e86_sub_uint4 (s1, s2));
...
unsigned op_a7 (e8086_t *c)
{
  ...
  if (c->prefix & (E86_PREFIX_REP | E86_PREFIX_REPN)) {
    ...
    while (c->dreg[E86_REG_CX] > 0) {
      ...
      e86_set_flags16 (c, DEFFLG, s1 - s2, s1);
      e86_set_flags_af (c, e86_sub_uint4 (s1, s2));
...
unsigned op_ac (e8086_t *c)
{
  ...
  c->dreg[E86_REG_AX] &= 0xff00;
  c->dreg[E86_REG_AX] |= e86_get_mem8 (c, seg, c->dreg[E86_REG_SI]);
...
unsigned op_ad (e8086_t *c)
{
  ...
  c->dreg[E86_REG_AX] = e86_get_mem16 (c, seg, c->dreg[E86_REG_SI]);
...
{
  c->dreg[E86_REG_CX] &= 0xff00;
  c->dreg[E86_REG_CX] |= c->pq[1];
  return (2);
}
...
{
  c->dreg[E86_REG_AX] &= 0x00ff;
  c->dreg[E86_REG_AX] |= c->pq[1] << 8;
  return (2);
}
...
{
  c->dreg[E86_REG_DX] &= 0x00ff;
  c->dreg[E86_REG_DX] |= c->pq[1] << 8;
  return (2);
}
...
{
  c->dreg[E86_REG_BX] &= 0x00ff;
  c->dreg[E86_REG_BX] |= c->pq[1] << 8;
  return (2);
}
...
{
  c->dreg[E86_REG_AX] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_CX] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_DX] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_BX] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_BP] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_SI] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
{
  c->dreg[E86_REG_DI] = e86_mk_uint16 (c->pq[1], c->pq[2]);
  return (3);
}
...
unsigned op_d5 (e8086_t *c)
{
  ...
  e86_set_flags16 (c, E86_FLG_S | E86_FLG_Z | E86_FLG_P, d, 0);
...
unsigned op_d7 (e8086_t *c)
{
  ...
  seg = e86_get_seg (c, E86_REG_DS);
  ofs = (c->dreg[E86_REG_BX] + (c->dreg[E86_REG_AX] & 0xff)) & 0xffff;
...
{
  c->dreg[E86_REG_CX] = (c->dreg[E86_REG_CX] - 1) & 0xffff;

  if ((c->dreg[E86_REG_CX] != 0) && ((c->flg & E86_FLG_Z) == 0)) {
...
{
  e86_set_prt8 (c, c->pq[1], c->dreg[E86_REG_AX] & 0xff);
...
{
  e86_set_prt16 (c, c->pq[1], c->dreg[E86_REG_AX]);
...
{
  e86_set_prt8 (c, c->dreg[E86_REG_DX], c->dreg[E86_REG_AX] & 0xff);
...
{
  e86_set_prt16 (c, c->dreg[E86_REG_DX], c->dreg[E86_REG_AX]);
...
unsigned op_f6_03 (e8086_t *c)
{
  ...
  e86_set_ea8 (c, d);
  e86_set_flags8 (c, DEFFLG & ~E86_FLG_C, d, s);
  e86_set_cf (c, d != 0);
...
unsigned op_f7_04 (e8086_t *c)
{
  ...
  s = e86_get_ea16 (c);
  d = s * (c->dreg[E86_REG_AX] & 0xffff);

  c->dreg[E86_REG_AX] = d & 0xffff;
  c->dreg[E86_REG_DX] = (d >> 16) & 0xffff;
