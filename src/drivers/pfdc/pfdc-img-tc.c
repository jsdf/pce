...
/*****************************************************************************
 * File name:   src/drivers/pfdc/pfdc-img-tc.c                               *
...
static
int mfm_decode_dam (mfm_t *mfm, pfdc_sct_t *sct, unsigned mark)
{
	unsigned      crc;
	unsigned char buf[4];
...
static
int mfm_decode_mark (mfm_t *mfm, pfdc_img_t *img, unsigned mark, int fm, unsigned c, unsigned h)
{
	unsigned      index;
	unsigned long idx;
	int           fm2;
