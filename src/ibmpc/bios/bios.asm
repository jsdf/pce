...
; $Id: bios.asm,v 1.1 2003/04/23 12:48:43 hampa Exp $
...
db 0xC3                                 ; F577 ret
L_F578:
db 0xB4, 0x00                           ; F578 mov ah,0x0
db 0x50                                 ; F57A push ax
db 0xE8, 0x84, 0x01                     ; F57B call 0xf702
db 0x8B, 0xF8                           ; F57E mov di,ax
db 0x58                                 ; F580 pop ax
db 0x3C, 0x80                           ; F581 cmp al,0x80
db 0x73, 0x06                           ; F583 jnc 0xf58b
db 0xBE, 0x6E, 0xFA                     ; F585 mov si,0xfa6e
db 0x0E                                 ; F588 push cs
db 0xEB, 0x0F                           ; F589 jmp short 0xf59a
db 0x2C, 0x80                           ; F58B sub al,0x80
db 0x1E                                 ; F58D push ds
db 0x2B, 0xF6                           ; F58E sub si,si
db 0x8E, 0xDE                           ; F590 mov ds,si
db 0xC5, 0x36, 0x7C, 0x00               ; F592 lds si,[0x7c]
db 0x8C, 0xDA                           ; F596 mov dx,ds
db 0x1F                                 ; F598 pop ds
db 0x52                                 ; F599 push dx
db 0xD1, 0xE0                           ; F59A shl ax,1
db 0xD1, 0xE0                           ; F59C shl ax,1
db 0xD1, 0xE0                           ; F59E shl ax,1
db 0x03, 0xF0                           ; F5A0 add si,ax
db 0x80, 0x3E, 0x49, 0x00, 0x06         ; F5A2 cmp byte [0x49],0x6
db 0x1F                                 ; F5A7 pop ds
db 0x72, 0x2C                           ; F5A8 jc 0xf5d6
db 0x57                                 ; F5AA push di
db 0x56                                 ; F5AB push si
db 0xB6, 0x04                           ; F5AC mov dh,0x4
db 0xAC                                 ; F5AE lodsb
db 0xF6, 0xC3, 0x80                     ; F5AF test bl,0x80
db 0x75, 0x16                           ; F5B2 jnz 0xf5ca
db 0xAA                                 ; F5B4 stosb
db 0xAC                                 ; F5B5 lodsb
db 0x26, 0x88, 0x85, 0xFF, 0x1F         ; F5B6 mov [es:di+0x1fff],al
db 0x83, 0xC7, 0x4F                     ; F5BB add di,byte +0x4f
db 0xFE, 0xCE                           ; F5BE dec dh
db 0x75, 0xEC                           ; F5C0 jnz 0xf5ae
db 0x5E                                 ; F5C2 pop si
db 0x5F                                 ; F5C3 pop di
db 0x47                                 ; F5C4 inc di
db 0xE2, 0xE3                           ; F5C5 loop 0xf5aa
db 0xE9, 0xFB, 0xFB                     ; F5C7 jmp 0xf1c5
db 0x26, 0x32, 0x05                     ; F5CA xor al,[es:di]
db 0xAA                                 ; F5CD stosb
db 0xAC                                 ; F5CE lodsb
db 0x26, 0x32, 0x85, 0xFF, 0x1F         ; F5CF xor al,[es:di+0x1fff]
db 0xEB, 0xE0                           ; F5D4 jmp short 0xf5b6
...
db 0x45                                 ; F700 inc bp
db 0xC3                                 ; F701 ret
db 0xA1, 0x50, 0x00                     ; F702 mov ax,[0x50]
db 0x53                                 ; F705 push bx
db 0x8B, 0xD8                           ; F706 mov bx,ax
db 0x8A, 0xC4                           ; F708 mov al,ah
db 0xF6, 0x26, 0x4A, 0x00               ; F70A mul byte [0x4a]
db 0xD1, 0xE0                           ; F70E shl ax,1
db 0xD1, 0xE0                           ; F710 shl ax,1
db 0x2A, 0xFF                           ; F712 sub bh,bh
db 0x03, 0xC3                           ; F714 add ax,bx
db 0x5B                                 ; F716 pop bx
db 0xC3                                 ; F717 ret
...
db 0x00, 0x00                           ; FA6E add [bx+si],al
db 0x00, 0x00                           ; FA70 add [bx+si],al
db 0x00, 0x00                           ; FA72 add [bx+si],al
db 0x00, 0x00                           ; FA74 add [bx+si],al
db 0x7E, 0x81                           ; FA76 jng 0xf9f9
db 0xA5                                 ; FA78 movsw
db 0x81, 0xBD, 0x99, 0x81, 0x7E, 0x7E   ; FA79 cmp word [di+0x8199],0x7e7e
db 0xFF                                 ; FA7F db 0xFF
db 0xDB                                 ; FA80 db 0xDB
db 0xFF, 0xC3                           ; FA81 inc bx
db 0xE7, 0xFF                           ; FA83 out 0xff,ax
db 0x7E, 0x6C                           ; FA85 jng 0xfaf3
db 0xFE                                 ; FA87 db 0xFE
db 0xFE                                 ; FA88 db 0xFE
db 0xFE                                 ; FA89 db 0xFE
db 0x7C, 0x38                           ; FA8A jl 0xfac4
db 0x10, 0x00                           ; FA8C adc [bx+si],al
db 0x10, 0x38                           ; FA8E adc [bx+si],bh
db 0x7C, 0xFE                           ; FA90 jl 0xfa90
db 0x7C, 0x38                           ; FA92 jl 0xfacc
db 0x10, 0x00                           ; FA94 adc [bx+si],al
db 0x38, 0x7C, 0x38                     ; FA96 cmp [si+0x38],bh
db 0xFE                                 ; FA99 db 0xFE
db 0xFE                                 ; FA9A db 0xFE
db 0x7C, 0x38                           ; FA9B jl 0xfad5
db 0x7C, 0x10                           ; FA9D jl 0xfaaf
db 0x10, 0x38                           ; FA9F adc [bx+si],bh
db 0x7C, 0xFE                           ; FAA1 jl 0xfaa1
db 0x7C, 0x38                           ; FAA3 jl 0xfadd
db 0x7C, 0x00                           ; FAA5 jl 0xfaa7
db 0x00, 0x18                           ; FAA7 add [bx+si],bl
db 0x3C, 0x3C                           ; FAA9 cmp al,0x3c
db 0x18, 0x00                           ; FAAB sbb [bx+si],al
db 0x00, 0xFF                           ; FAAD add bh,bh
db 0xFF, 0xE7                           ; FAAF jmp di
db 0xC3                                 ; FAB1 ret
db 0xC3                                 ; FAB2 ret
db 0xE7, 0xFF                           ; FAB3 out 0xff,ax
db 0xFF, 0x00                           ; FAB5 inc word [bx+si]
db 0x3C, 0x66                           ; FAB7 cmp al,0x66
db 0x42                                 ; FAB9 inc dx
db 0x42                                 ; FABA inc dx
db 0x66, 0x3C, 0x00                     ; FABB o32 cmp al,0x0
db 0xFF, 0xC3                           ; FABE inc bx
db 0x99                                 ; FAC0 cwd
db 0xBD, 0xBD, 0x99                     ; FAC1 mov bp,0x99bd
db 0xC3                                 ; FAC4 ret
db 0xFF, 0x0F                           ; FAC5 dec word [bx]
db 0x07                                 ; FAC7 pop es
db 0x0F                                 ; FAC8 db 0x0F
db 0x7D, 0xCC                           ; FAC9 jnl 0xfa97
db 0xCC                                 ; FACB int3
db 0xCC                                 ; FACC int3
db 0x78, 0x3C                           ; FACD js 0xfb0b
db 0x66, 0x66, 0x66, 0x3C, 0x18         ; FACF o32 cmp al,0x18
db 0x7E, 0x18                           ; FAD4 jng 0xfaee
db 0x3F                                 ; FAD6 aas
db 0x33, 0x3F                           ; FAD7 xor di,[bx]
db 0x30, 0x30                           ; FAD9 xor [bx+si],dh
db 0x70, 0xF0                           ; FADB jo 0xfacd
db 0xE0, 0x7F                           ; FADD loopne 0xfb5e
db 0x63, 0x7F, 0x63                     ; FADF arpl [bx+0x63],di
db 0x63, 0x67, 0xE6                     ; FAE2 arpl [bx-0x1a],sp
db 0xC0, 0x99, 0x5A, 0x3C, 0xE7         ; FAE5 rcr byte [bx+di+0x3c5a],0xe7
db 0xE7, 0x3C                           ; FAEA out 0x3c,ax
db 0x5A                                 ; FAEC pop dx
db 0x99                                 ; FAED cwd
db 0x80, 0xE0, 0xF8                     ; FAEE and al,0xf8
db 0xFE                                 ; FAF1 db 0xFE
db 0xF8                                 ; FAF2 clc
db 0xE0, 0x80                           ; FAF3 loopne 0xfa75
db 0x00, 0x02                           ; FAF5 add [bp+si],al
db 0x0E                                 ; FAF7 push cs
db 0x3E                                 ; FAF8 db 0x3E
db 0xFE                                 ; FAF9 db 0xFE
db 0x3E, 0x0E                           ; FAFA ds push cs
db 0x02, 0x00                           ; FAFC add al,[bx+si]
db 0x18, 0x3C                           ; FAFE sbb [si],bh
db 0x7E, 0x18                           ; FB00 jng 0xfb1a
db 0x18, 0x7E, 0x3C                     ; FB02 sbb [bp+0x3c],bh
db 0x18, 0x66, 0x66                     ; FB05 sbb [bp+0x66],ah
db 0x66, 0x66, 0x66, 0x00, 0x66, 0x00   ; FB08 o32 add [bp+0x0],ah
db 0x7F, 0xDB                           ; FB0E jg 0xfaeb
db 0xDB, 0x7B, 0x1B                     ; FB10 fstp tword [bp+di+0x1b]
db 0x1B, 0x1B                           ; FB13 sbb bx,[bp+di]
db 0x00, 0x3E, 0x63, 0x38               ; FB15 add [0x3863],bh
db 0x6C                                 ; FB19 insb
db 0x6C                                 ; FB1A insb
db 0x38, 0xCC                           ; FB1B cmp ah,cl
db 0x78, 0x00                           ; FB1D js 0xfb1f
db 0x00, 0x00                           ; FB1F add [bx+si],al
db 0x00, 0x7E, 0x7E                     ; FB21 add [bp+0x7e],bh
db 0x7E, 0x00                           ; FB24 jng 0xfb26
db 0x18, 0x3C                           ; FB26 sbb [si],bh
db 0x7E, 0x18                           ; FB28 jng 0xfb42
db 0x7E, 0x3C                           ; FB2A jng 0xfb68
db 0x18, 0xFF                           ; FB2C sbb bh,bh
db 0x18, 0x3C                           ; FB2E sbb [si],bh
db 0x7E, 0x18                           ; FB30 jng 0xfb4a
db 0x18, 0x18                           ; FB32 sbb [bx+si],bl
db 0x18, 0x00                           ; FB34 sbb [bx+si],al
db 0x18, 0x18                           ; FB36 sbb [bx+si],bl
db 0x18, 0x18                           ; FB38 sbb [bx+si],bl
db 0x7E, 0x3C                           ; FB3A jng 0xfb78
db 0x18, 0x00                           ; FB3C sbb [bx+si],al
db 0x00, 0x18                           ; FB3E add [bx+si],bl
db 0x0C, 0xFE                           ; FB40 or al,0xfe
db 0x0C, 0x18                           ; FB42 or al,0x18
db 0x00, 0x00                           ; FB44 add [bx+si],al
db 0x00, 0x30                           ; FB46 add [bx+si],dh
db 0x60                                 ; FB48 pusha
db 0xFE                                 ; FB49 db 0xFE
db 0x60                                 ; FB4A pusha
db 0x30, 0x00                           ; FB4B xor [bx+si],al
db 0x00, 0x00                           ; FB4D add [bx+si],al
db 0x00, 0xC0                           ; FB4F add al,al
db 0xC0, 0xC0, 0xFE                     ; FB51 rol al,0xfe
db 0x00, 0x00                           ; FB54 add [bx+si],al
db 0x00, 0x24                           ; FB56 add [si],ah
db 0x66, 0xFF, 0x66, 0x24               ; FB58 jmp dword near [bp+0x24]
db 0x00, 0x00                           ; FB5C add [bx+si],al
db 0x00, 0x18                           ; FB5E add [bx+si],bl
db 0x3C, 0x7E                           ; FB60 cmp al,0x7e
db 0xFF                                 ; FB62 db 0xFF
db 0xFF, 0x00                           ; FB63 inc word [bx+si]
db 0x00, 0x00                           ; FB65 add [bx+si],al
db 0xFF                                 ; FB67 db 0xFF
db 0xFF                                 ; FB68 db 0xFF
db 0x7E, 0x3C                           ; FB69 jng 0xfba7
db 0x18, 0x00                           ; FB6B sbb [bx+si],al
db 0x00, 0x00                           ; FB6D add [bx+si],al
db 0x00, 0x00                           ; FB6F add [bx+si],al
db 0x00, 0x00                           ; FB71 add [bx+si],al
db 0x00, 0x00                           ; FB73 add [bx+si],al
db 0x00, 0x30                           ; FB75 add [bx+si],dh
db 0x78, 0x78                           ; FB77 js 0xfbf1
db 0x30, 0x30                           ; FB79 xor [bx+si],dh
db 0x00, 0x30                           ; FB7B add [bx+si],dh
db 0x00, 0x6C, 0x6C                     ; FB7D add [si+0x6c],ch
db 0x6C                                 ; FB80 insb
db 0x00, 0x00                           ; FB81 add [bx+si],al
db 0x00, 0x00                           ; FB83 add [bx+si],al
db 0x00, 0x6C, 0x6C                     ; FB85 add [si+0x6c],ch
db 0xFE                                 ; FB88 db 0xFE
db 0x6C                                 ; FB89 insb
db 0xFE                                 ; FB8A db 0xFE
db 0x6C                                 ; FB8B insb
db 0x6C                                 ; FB8C insb
db 0x00, 0x30                           ; FB8D add [bx+si],dh
db 0x7C, 0xC0                           ; FB8F jl 0xfb51
db 0x78, 0x0C                           ; FB91 js 0xfb9f
db 0xF8                                 ; FB93 clc
db 0x30, 0x00                           ; FB94 xor [bx+si],al
db 0x00, 0xC6                           ; FB96 add dh,al
db 0xCC                                 ; FB98 int3
db 0x18, 0x30                           ; FB99 sbb [bx+si],dh
db 0x66, 0xC6, 0x00, 0x38               ; FB9B o32 mov byte [bx+si],0x38
db 0x6C                                 ; FB9F insb
db 0x38, 0x76, 0xDC                     ; FBA0 cmp [bp-0x24],dh
db 0xCC                                 ; FBA3 int3
db 0x76, 0x00                           ; FBA4 jna 0xfba6
db 0x60                                 ; FBA6 pusha
db 0x60                                 ; FBA7 pusha
db 0xC0, 0x00, 0x00                     ; FBA8 rol byte [bx+si],0x0
db 0x00, 0x00                           ; FBAB add [bx+si],al
db 0x00, 0x18                           ; FBAD add [bx+si],bl
db 0x30, 0x60, 0x60                     ; FBAF xor [bx+si+0x60],ah
db 0x60                                 ; FBB2 pusha
db 0x30, 0x18                           ; FBB3 xor [bx+si],bl
db 0x00, 0x60, 0x30                     ; FBB5 add [bx+si+0x30],ah
db 0x18, 0x18                           ; FBB8 sbb [bx+si],bl
db 0x18, 0x30                           ; FBBA sbb [bx+si],dh
db 0x60                                 ; FBBC pusha
db 0x00, 0x00                           ; FBBD add [bx+si],al
db 0x66, 0x3C, 0xFF                     ; FBBF o32 cmp al,0xff
db 0x3C, 0x66                           ; FBC2 cmp al,0x66
db 0x00, 0x00                           ; FBC4 add [bx+si],al
db 0x00, 0x30                           ; FBC6 add [bx+si],dh
db 0x30, 0xFC                           ; FBC8 xor ah,bh
db 0x30, 0x30                           ; FBCA xor [bx+si],dh
db 0x00, 0x00                           ; FBCC add [bx+si],al
db 0x00, 0x00                           ; FBCE add [bx+si],al
db 0x00, 0x00                           ; FBD0 add [bx+si],al
db 0x00, 0x30                           ; FBD2 add [bx+si],dh
db 0x30, 0x60, 0x00                     ; FBD4 xor [bx+si+0x0],ah
db 0x00, 0x00                           ; FBD7 add [bx+si],al
db 0xFC                                 ; FBD9 cld
db 0x00, 0x00                           ; FBDA add [bx+si],al
db 0x00, 0x00                           ; FBDC add [bx+si],al
db 0x00, 0x00                           ; FBDE add [bx+si],al
db 0x00, 0x00                           ; FBE0 add [bx+si],al
db 0x00, 0x30                           ; FBE2 add [bx+si],dh
db 0x30, 0x00                           ; FBE4 xor [bx+si],al
db 0x06                                 ; FBE6 push es
db 0x0C, 0x18                           ; FBE7 or al,0x18
db 0x30, 0x60, 0xC0                     ; FBE9 xor [bx+si-0x40],ah
db 0x80, 0x00, 0x7C                     ; FBEC add byte [bx+si],0x7c
db 0xC6                                 ; FBEF db 0xC6
db 0xCE                                 ; FBF0 into
db 0xDE, 0xF6                           ; FBF1 fdivrp st6
db 0xE6, 0x7C                           ; FBF3 out 0x7c,al
db 0x00, 0x30                           ; FBF5 add [bx+si],dh
db 0x70, 0x30                           ; FBF7 jo 0xfc29
db 0x30, 0x30                           ; FBF9 xor [bx+si],dh
db 0x30, 0xFC                           ; FBFB xor ah,bh
db 0x00, 0x78, 0xCC                     ; FBFD add [bx+si-0x34],bh
db 0x0C, 0x38                           ; FC00 or al,0x38
db 0x60                                 ; FC02 pusha
db 0xCC                                 ; FC03 int3
db 0xFC                                 ; FC04 cld
db 0x00, 0x78, 0xCC                     ; FC05 add [bx+si-0x34],bh
db 0x0C, 0x38                           ; FC08 or al,0x38
db 0x0C, 0xCC                           ; FC0A or al,0xcc
db 0x78, 0x00                           ; FC0C js 0xfc0e
db 0x1C, 0x3C                           ; FC0E sbb al,0x3c
db 0x6C                                 ; FC10 insb
db 0xCC                                 ; FC11 int3
db 0xFE, 0x0C                           ; FC12 dec byte [si]
db 0x1E                                 ; FC14 push ds
db 0x00, 0xFC                           ; FC15 add ah,bh
db 0xC0, 0xF8, 0x0C                     ; FC17 sar al,0xc
db 0x0C, 0xCC                           ; FC1A or al,0xcc
db 0x78, 0x00                           ; FC1C js 0xfc1e
db 0x38, 0x60, 0xC0                     ; FC1E cmp [bx+si-0x40],ah
db 0xF8                                 ; FC21 clc
db 0xCC                                 ; FC22 int3
db 0xCC                                 ; FC23 int3
db 0x78, 0x00                           ; FC24 js 0xfc26
db 0xFC                                 ; FC26 cld
db 0xCC                                 ; FC27 int3
db 0x0C, 0x18                           ; FC28 or al,0x18
db 0x30, 0x30                           ; FC2A xor [bx+si],dh
db 0x30, 0x00                           ; FC2C xor [bx+si],al
db 0x78, 0xCC                           ; FC2E js 0xfbfc
db 0xCC                                 ; FC30 int3
db 0x78, 0xCC                           ; FC31 js 0xfbff
db 0xCC                                 ; FC33 int3
db 0x78, 0x00                           ; FC34 js 0xfc36
db 0x78, 0xCC                           ; FC36 js 0xfc04
db 0xCC                                 ; FC38 int3
db 0x7C, 0x0C                           ; FC39 jl 0xfc47
db 0x18, 0x70, 0x00                     ; FC3B sbb [bx+si+0x0],dh
db 0x00, 0x30                           ; FC3E add [bx+si],dh
db 0x30, 0x00                           ; FC40 xor [bx+si],al
db 0x00, 0x30                           ; FC42 add [bx+si],dh
db 0x30, 0x00                           ; FC44 xor [bx+si],al
db 0x00, 0x30                           ; FC46 add [bx+si],dh
db 0x30, 0x00                           ; FC48 xor [bx+si],al
db 0x00, 0x30                           ; FC4A add [bx+si],dh
db 0x30, 0x60, 0x18                     ; FC4C xor [bx+si+0x18],ah
db 0x30, 0x60, 0xC0                     ; FC4F xor [bx+si-0x40],ah
db 0x60                                 ; FC52 pusha
db 0x30, 0x18                           ; FC53 xor [bx+si],bl
db 0x00, 0x00                           ; FC55 add [bx+si],al
db 0x00, 0xFC                           ; FC57 add ah,bh
db 0x00, 0x00                           ; FC59 add [bx+si],al
db 0xFC                                 ; FC5B cld
db 0x00, 0x00                           ; FC5C add [bx+si],al
db 0x60                                 ; FC5E pusha
db 0x30, 0x18                           ; FC5F xor [bx+si],bl
db 0x0C, 0x18                           ; FC61 or al,0x18
db 0x30, 0x60, 0x00                     ; FC63 xor [bx+si+0x0],ah
db 0x78, 0xCC                           ; FC66 js 0xfc34
db 0x0C, 0x18                           ; FC68 or al,0x18
db 0x30, 0x00                           ; FC6A xor [bx+si],al
db 0x30, 0x00                           ; FC6C xor [bx+si],al
db 0x7C, 0xC6                           ; FC6E jl 0xfc36
db 0xDE                                 ; FC70 db 0xDE
db 0xDE                                 ; FC71 db 0xDE
db 0xDE, 0xC0                           ; FC72 faddp st0
db 0x78, 0x00                           ; FC74 js 0xfc76
db 0x30, 0x78, 0xCC                     ; FC76 xor [bx+si-0x34],bh
db 0xCC                                 ; FC79 int3
db 0xFC                                 ; FC7A cld
db 0xCC                                 ; FC7B int3
db 0xCC                                 ; FC7C int3
db 0x00, 0xFC                           ; FC7D add ah,bh
db 0x66, 0x66, 0x7C, 0x66               ; FC7F o32 jl 0xfce9
db 0x66, 0xFC                           ; FC83 o32 cld
db 0x00, 0x3C                           ; FC85 add [si],bh
db 0x66, 0xC0, 0xC0, 0xC0               ; FC87 o32 rol al,0xc0
db 0x66, 0x3C, 0x00                     ; FC8B o32 cmp al,0x0
db 0xF8                                 ; FC8E clc
db 0x6C                                 ; FC8F insb
db 0x66, 0x66, 0x66, 0x6C               ; FC90 o32 insb
db 0xF8                                 ; FC94 clc
db 0x00, 0xFE                           ; FC95 add dh,bh
db 0x62, 0x68, 0x78                     ; FC97 bound bp,[bx+si+0x78]
db 0x68, 0x62, 0xFE                     ; FC9A push word 0xfe62
db 0x00, 0xFE                           ; FC9D add dh,bh
db 0x62, 0x68, 0x78                     ; FC9F bound bp,[bx+si+0x78]
db 0x68, 0x60, 0xF0                     ; FCA2 push word 0xf060
db 0x00, 0x3C                           ; FCA5 add [si],bh
db 0x66, 0xC0, 0xC0, 0xCE               ; FCA7 o32 rol al,0xce
db 0x66, 0x3E, 0x00, 0xCC               ; FCAB ds o32 add ah,cl
db 0xCC                                 ; FCAF int3
db 0xCC                                 ; FCB0 int3
db 0xFC                                 ; FCB1 cld
db 0xCC                                 ; FCB2 int3
db 0xCC                                 ; FCB3 int3
db 0xCC                                 ; FCB4 int3
db 0x00, 0x78, 0x30                     ; FCB5 add [bx+si+0x30],bh
db 0x30, 0x30                           ; FCB8 xor [bx+si],dh
db 0x30, 0x30                           ; FCBA xor [bx+si],dh
db 0x78, 0x00                           ; FCBC js 0xfcbe
db 0x1E                                 ; FCBE push ds
db 0x0C, 0x0C                           ; FCBF or al,0xc
db 0x0C, 0xCC                           ; FCC1 or al,0xcc
db 0xCC                                 ; FCC3 int3
db 0x78, 0x00                           ; FCC4 js 0xfcc6
db 0xE6, 0x66                           ; FCC6 out 0x66,al
db 0x6C                                 ; FCC8 insb
db 0x78, 0x6C                           ; FCC9 js 0xfd37
db 0x66, 0xE6, 0x00                     ; FCCB o32 out 0x0,al
db 0xF0, 0x60                           ; FCCE lock pusha
db 0x60                                 ; FCD0 pusha
db 0x60                                 ; FCD1 pusha
db 0x62, 0x66, 0xFE                     ; FCD2 bound sp,[bp-0x2]
db 0x00, 0xC6                           ; FCD5 add dh,al
db 0xEE                                 ; FCD7 out dx,al
db 0xFE                                 ; FCD8 db 0xFE
db 0xFE                                 ; FCD9 db 0xFE
db 0xD6                                 ; FCDA salc
db 0xC6, 0xC6, 0x00                     ; FCDB mov dh,0x0
db 0xC6                                 ; FCDE db 0xC6
db 0xE6, 0xF6                           ; FCDF out 0xf6,al
db 0xDE, 0xCE                           ; FCE1 fmulp st6
db 0xC6, 0xC6, 0x00                     ; FCE3 mov dh,0x0
db 0x38, 0x6C, 0xC6                     ; FCE6 cmp [si-0x3a],ch
db 0xC6, 0xC6, 0x6C                     ; FCE9 mov dh,0x6c
db 0x38, 0x00                           ; FCEC cmp [bx+si],al
db 0xFC                                 ; FCEE cld
db 0x66, 0x66, 0x7C, 0x60               ; FCEF o32 jl 0xfd53
db 0x60                                 ; FCF3 pusha
db 0xF0, 0x00, 0x78, 0xCC               ; FCF4 lock add [bx+si-0x34],bh
db 0xCC                                 ; FCF8 int3
db 0xCC                                 ; FCF9 int3
db 0xDC, 0x78, 0x1C                     ; FCFA fdivr qword [bx+si+0x1c]
db 0x00, 0xFC                           ; FCFD add ah,bh
db 0x66, 0x66, 0x7C, 0x6C               ; FCFF o32 jl 0xfd6f
db 0x66, 0xE6, 0x00                     ; FD03 o32 out 0x0,al
db 0x78, 0xCC                           ; FD06 js 0xfcd4
db 0xE0, 0x70                           ; FD08 loopne 0xfd7a
db 0x1C, 0xCC                           ; FD0A sbb al,0xcc
db 0x78, 0x00                           ; FD0C js 0xfd0e
db 0xFC                                 ; FD0E cld
db 0xB4, 0x30                           ; FD0F mov ah,0x30
db 0x30, 0x30                           ; FD11 xor [bx+si],dh
db 0x30, 0x78, 0x00                     ; FD13 xor [bx+si+0x0],bh
db 0xCC                                 ; FD16 int3
db 0xCC                                 ; FD17 int3
db 0xCC                                 ; FD18 int3
db 0xCC                                 ; FD19 int3
...
db 0xCC                                 ; FD1B int3
db 0xFC                                 ; FD1C cld
db 0x00, 0xCC                           ; FD1D add ah,cl
db 0xCC                                 ; FD1F int3
db 0xCC                                 ; FD20 int3
db 0xCC                                 ; FD21 int3
db 0xCC                                 ; FD22 int3
db 0x78, 0x30                           ; FD23 js 0xfd55
db 0x00, 0xC6                           ; FD25 add dh,al
db 0xC6, 0xC6, 0xD6                     ; FD27 mov dh,0xd6
db 0xFE                                 ; FD2A db 0xFE
db 0xEE                                 ; FD2B out dx,al
db 0xC6, 0x00, 0xC6                     ; FD2C mov byte [bx+si],0xc6
db 0xC6                                 ; FD2F db 0xC6
db 0x6C                                 ; FD30 insb
db 0x38, 0x38                           ; FD31 cmp [bx+si],bh
db 0x6C                                 ; FD33 insb
db 0xC6, 0x00, 0xCC                     ; FD34 mov byte [bx+si],0xcc
db 0xCC                                 ; FD37 int3
db 0xCC                                 ; FD38 int3
db 0x78, 0x30                           ; FD39 js 0xfd6b
db 0x30, 0x78, 0x00                     ; FD3B xor [bx+si+0x0],bh
db 0xFE, 0xC6                           ; FD3E inc dh
db 0x8C, 0x18                           ; FD40 mov [bx+si],ds
db 0x32, 0x66, 0xFE                     ; FD42 xor ah,[bp-0x2]
db 0x00, 0x78, 0x60                     ; FD45 add [bx+si+0x60],bh
db 0x60                                 ; FD48 pusha
db 0x60                                 ; FD49 pusha
db 0x60                                 ; FD4A pusha
db 0x60                                 ; FD4B pusha
db 0x78, 0x00                           ; FD4C js 0xfd4e
db 0xC0, 0x60, 0x30, 0x18               ; FD4E shl byte [bx+si+0x30],0x18
db 0x0C, 0x06                           ; FD52 or al,0x6
db 0x02, 0x00                           ; FD54 add al,[bx+si]
db 0x78, 0x18                           ; FD56 js 0xfd70
db 0x18, 0x18                           ; FD58 sbb [bx+si],bl
db 0x18, 0x18                           ; FD5A sbb [bx+si],bl
db 0x78, 0x00                           ; FD5C js 0xfd5e
db 0x10, 0x38                           ; FD5E adc [bx+si],bh
db 0x6C                                 ; FD60 insb
db 0xC6, 0x00, 0x00                     ; FD61 mov byte [bx+si],0x0
db 0x00, 0x00                           ; FD64 add [bx+si],al
db 0x00, 0x00                           ; FD66 add [bx+si],al
db 0x00, 0x00                           ; FD68 add [bx+si],al
db 0x00, 0x00                           ; FD6A add [bx+si],al
db 0x00, 0xFF                           ; FD6C add bh,bh
db 0x30, 0x30                           ; FD6E xor [bx+si],dh
db 0x18, 0x00                           ; FD70 sbb [bx+si],al
db 0x00, 0x00                           ; FD72 add [bx+si],al
db 0x00, 0x00                           ; FD74 add [bx+si],al
db 0x00, 0x00                           ; FD76 add [bx+si],al
db 0x78, 0x0C                           ; FD78 js 0xfd86
db 0x7C, 0xCC                           ; FD7A jl 0xfd48
db 0x76, 0x00                           ; FD7C jna 0xfd7e
db 0xE0, 0x60                           ; FD7E loopne 0xfde0
db 0x60                                 ; FD80 pusha
db 0x7C, 0x66                           ; FD81 jl 0xfde9
db 0x66, 0xDC, 0x00                     ; FD83 o32 fadd qword [bx+si]
db 0x00, 0x00                           ; FD86 add [bx+si],al
db 0x78, 0xCC                           ; FD88 js 0xfd56
db 0xC0, 0xCC, 0x78                     ; FD8A ror ah,0x78
db 0x00, 0x1C                           ; FD8D add [si],bl
db 0x0C, 0x0C                           ; FD8F or al,0xc
db 0x7C, 0xCC                           ; FD91 jl 0xfd5f
db 0xCC                                 ; FD93 int3
db 0x76, 0x00                           ; FD94 jna 0xfd96
db 0x00, 0x00                           ; FD96 add [bx+si],al
db 0x78, 0xCC                           ; FD98 js 0xfd66
db 0xFC                                 ; FD9A cld
db 0xC0, 0x78, 0x00, 0x38               ; FD9B sar byte [bx+si+0x0],0x38
db 0x6C                                 ; FD9F insb
db 0x60                                 ; FDA0 pusha
db 0xF0, 0x60                           ; FDA1 lock pusha
db 0x60                                 ; FDA3 pusha
db 0xF0, 0x00, 0x00                     ; FDA4 lock add [bx+si],al
db 0x00, 0x76, 0xCC                     ; FDA7 add [bp-0x34],dh
db 0xCC                                 ; FDAA int3
db 0x7C, 0x0C                           ; FDAB jl 0xfdb9
db 0xF8                                 ; FDAD clc
db 0xE0, 0x60                           ; FDAE loopne 0xfe10
db 0x6C                                 ; FDB0 insb
db 0x76, 0x66                           ; FDB1 jna 0xfe19
db 0x66, 0xE6, 0x00                     ; FDB3 o32 out 0x0,al
db 0x30, 0x00                           ; FDB6 xor [bx+si],al
db 0x70, 0x30                           ; FDB8 jo 0xfdea
db 0x30, 0x30                           ; FDBA xor [bx+si],dh
db 0x78, 0x00                           ; FDBC js 0xfdbe
db 0x0C, 0x00                           ; FDBE or al,0x0
db 0x0C, 0x0C                           ; FDC0 or al,0xc
db 0x0C, 0xCC                           ; FDC2 or al,0xcc
db 0xCC                                 ; FDC4 int3
db 0x78, 0xE0                           ; FDC5 js 0xfda7
db 0x60                                 ; FDC7 pusha
db 0x66, 0x6C                           ; FDC8 o32 insb
db 0x78, 0x6C                           ; FDCA js 0xfe38
db 0xE6, 0x00                           ; FDCC out 0x0,al
db 0x70, 0x30                           ; FDCE jo 0xfe00
db 0x30, 0x30                           ; FDD0 xor [bx+si],dh
db 0x30, 0x30                           ; FDD2 xor [bx+si],dh
db 0x78, 0x00                           ; FDD4 js 0xfdd6
db 0x00, 0x00                           ; FDD6 add [bx+si],al
db 0xCC                                 ; FDD8 int3
db 0xFE                                 ; FDD9 db 0xFE
db 0xFE                                 ; FDDA db 0xFE
db 0xD6                                 ; FDDB salc
db 0xC6, 0x00, 0x00                     ; FDDC mov byte [bx+si],0x0
db 0x00, 0xF8                           ; FDDF add al,bh
db 0xCC                                 ; FDE1 int3
db 0xCC                                 ; FDE2 int3
db 0xCC                                 ; FDE3 int3
db 0xCC                                 ; FDE4 int3
db 0x00, 0x00                           ; FDE5 add [bx+si],al
db 0x00, 0x78, 0xCC                     ; FDE7 add [bx+si-0x34],bh
db 0xCC                                 ; FDEA int3
db 0xCC                                 ; FDEB int3
db 0x78, 0x00                           ; FDEC js 0xfdee
db 0x00, 0x00                           ; FDEE add [bx+si],al
db 0xDC, 0x66, 0x66                     ; FDF0 fsub qword [bp+0x66]
db 0x7C, 0x60                           ; FDF3 jl 0xfe55
db 0xF0, 0x00, 0x00                     ; FDF5 lock add [bx+si],al
db 0x76, 0xCC                           ; FDF8 jna 0xfdc6
db 0xCC                                 ; FDFA int3
db 0x7C, 0x0C                           ; FDFB jl 0xfe09
db 0x1E                                 ; FDFD push ds
db 0x00, 0x00                           ; FDFE add [bx+si],al
db 0xDC, 0x76, 0x66                     ; FE00 fdiv qword [bp+0x66]
db 0x60                                 ; FE03 pusha
db 0xF0, 0x00, 0x00                     ; FE04 lock add [bx+si],al
db 0x00, 0x7C, 0xC0                     ; FE07 add [si-0x40],bh
db 0x78, 0x0C                           ; FE0A js 0xfe18
db 0xF8                                 ; FE0C clc
db 0x00, 0x10                           ; FE0D add [bx+si],dl
db 0x30, 0x7C, 0x30                     ; FE0F xor [si+0x30],bh
db 0x30, 0x34                           ; FE12 xor [si],dh
db 0x18, 0x00                           ; FE14 sbb [bx+si],al
db 0x00, 0x00                           ; FE16 add [bx+si],al
db 0xCC                                 ; FE18 int3
db 0xCC                                 ; FE19 int3
db 0xCC                                 ; FE1A int3
db 0xCC                                 ; FE1B int3
db 0x76, 0x00                           ; FE1C jna 0xfe1e
db 0x00, 0x00                           ; FE1E add [bx+si],al
db 0xCC                                 ; FE20 int3
db 0xCC                                 ; FE21 int3
db 0xCC                                 ; FE22 int3
db 0x78, 0x30                           ; FE23 js 0xfe55
db 0x00, 0x00                           ; FE25 add [bx+si],al
db 0x00, 0xC6                           ; FE27 add dh,al
db 0xD6                                 ; FE29 salc
db 0xFE                                 ; FE2A db 0xFE
db 0xFE                                 ; FE2B db 0xFE
db 0x6C                                 ; FE2C insb
db 0x00, 0x00                           ; FE2D add [bx+si],al
db 0x00, 0xC6                           ; FE2F add dh,al
db 0x6C                                 ; FE31 insb
db 0x38, 0x6C, 0xC6                     ; FE32 cmp [si-0x3a],ch
db 0x00, 0x00                           ; FE35 add [bx+si],al
db 0x00, 0xCC                           ; FE37 add ah,cl
db 0xCC                                 ; FE39 int3
db 0xCC                                 ; FE3A int3
db 0x7C, 0x0C                           ; FE3B jl 0xfe49
db 0xF8                                 ; FE3D clc
db 0x00, 0x00                           ; FE3E add [bx+si],al
db 0xFC                                 ; FE40 cld
db 0x98                                 ; FE41 cbw
db 0x30, 0x64, 0xFC                     ; FE42 xor [si-0x4],ah
db 0x00, 0x1C                           ; FE45 add [si],bl
db 0x30, 0x30                           ; FE47 xor [bx+si],dh
db 0xE0, 0x30                           ; FE49 loopne 0xfe7b
db 0x30, 0x1C                           ; FE4B xor [si],bl
db 0x00, 0x18                           ; FE4D add [bx+si],bl
db 0x18, 0x18                           ; FE4F sbb [bx+si],bl
db 0x00, 0x18                           ; FE51 add [bx+si],bl
db 0x18, 0x18                           ; FE53 sbb [bx+si],bl
db 0x00, 0xE0                           ; FE55 add al,ah
db 0x30, 0x30                           ; FE57 xor [bx+si],dh
db 0x1C, 0x30                           ; FE59 sbb al,0x30
db 0x30, 0xE0                           ; FE5B xor al,ah
db 0x00, 0x76, 0xDC                     ; FE5D add [bp-0x24],dh
db 0x00, 0x00                           ; FE60 add [bx+si],al
db 0x00, 0x00                           ; FE62 add [bx+si],al
db 0x00, 0x00                           ; FE64 add [bx+si],al
db 0x00, 0x10                           ; FE66 add [bx+si],dl
db 0x38, 0x6C, 0xC6                     ; FE68 cmp [si-0x3a],ch
db 0xC6                                 ; FE6B db 0xC6
db 0xFE, 0x00                           ; FE6C inc byte [bx+si]
